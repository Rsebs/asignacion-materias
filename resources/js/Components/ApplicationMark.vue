<template>
    <svg viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#2B2A4C"
        ...
        <g id="SVGRepo_iconCarrier">
            <path
                ...
                stroke="#2B2A4C" stroke-width="1.512" stroke-linecap="round" stroke-linejoin="round"></path>
        </g>
    </svg>
</template>
